...
var amsActivityControllers = angular.module('amsActivityControllers', []);

amsActivityControllers.controller('UserListCtrl', ['$scope', '$http',
...
amsActivityControllers.controller('UserDetailCtrl', ['$scope', '$routeParams',
  function($scope, $routeParams) {
    $scope.phoneId = $routeParams.phoneId;
  }]);

amsActivityControllers.controller('UserAddCtrl', ['$scope', '$http', '$location','$routeParams',
